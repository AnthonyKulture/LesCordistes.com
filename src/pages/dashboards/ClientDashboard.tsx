        ...
        <DashboardLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <Button
                        variant="primary"
                        onClick={() => navigate(mode === 'recruiter' ? '/post-job?type=renfort_pro' : '/post-job')}
                            ...
                            <div className="space-y-4">
                                {jobs.map((job) => (
                                    <JobListItem
                                        key={job.id}
                                        job={job as any}
                                        onView={() => job.slug ? navigate(`/jobs/${job.slug}`) : toast.info('Cette mission est en cours de publication.')}
