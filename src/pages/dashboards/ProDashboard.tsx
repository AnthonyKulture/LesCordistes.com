            ...
            <div className="space-y-6">
                ...
                {profileCompletion < 70 && (
                    <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex items-center justify-between gap-4 shadow-sm animate-in fade-in slide-in-from-top-4 duration-500">
                        ...
                        <Button variant="outline" onClick={() => navigate('/profile')} className="shrink-0 text-xs border-orange-200 text-orange-700 hover:bg-orange-100">
                ...
                <div className="bg-gradient-to-r from-brand-blue to-blue-700 rounded-2xl p-5 text-white">
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <Button variant="secondary" onClick={() => navigate('/credits')} className="bg-white text-brand-blue hover:bg-blue-50 shrink-0 font-black">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <StatCard label="Crédits" value={`${balance} dispo.`} icon={Coins} iconBg="bg-yellow-100" iconColor="text-yellow-600" onClick={() => navigate('/credits')} />
                    <StatCard label="Profil" value={`${profileCompletion}% complet`} icon={TrendingUp} iconBg="bg-blue-100" iconColor="text-blue-600" onClick={() => navigate('/profile')} />
                    <StatCard label="Missions active" value={totalJobsCount ?? 0} icon={Briefcase} iconBg="bg-brand-blue/10" iconColor="text-brand-blue" onClick={() => navigate('/jobs')} />
                </div>
                        ...
                        <div className="bg-white rounded-xl border border-slate-100 overflow-hidden shadow-sm">
                            ...
                            {isLoadingLeads ? (
                                ...
                                <div className="text-center py-12 px-6">
                                    ...
                                    <Button variant="primary" onClick={() => navigate('/jobs')} className="shadow-lg shadow-brand-blue/20">
                        ...
                        <div className="bg-blue-50/50 rounded-xl border border-blue-100/50 overflow-hidden shadow-sm">
                            ...
                            {isLoadingPosted ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => navigate('/post-job?type=renfort_pro')} className="mt-3 text-xs">
                                        Demander du renfort
                                    </Button>
                                </div>
                            )}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
                            ...
                            <div className="space-y-2 text-sm">
                                <button onClick={() => navigate('/profile')} className="w-full flex items-center justify-between p-3 rounded-lg border border-slate-50 bg-slate-50/50 hover:bg-slate-100 transition-colors">
                                ...
                                <button onClick={() => navigate('/credits')} className="w-full flex items-center justify-between p-3 rounded-lg border border-slate-50 bg-slate-50/50 hover:bg-slate-100 transition-colors">
                                    <span className="flex items-center gap-3 font-medium text-slate-700">
                                        <Coins size={16} className="text-slate-400" /> Gérer mes crédits
                                    </span>
                                    <ChevronRight size={14} className="text-slate-300" />
                                </button>
                                <button onClick={() => navigate('/pro/widget')} className="w-full flex items-center justify-between p-3 rounded-lg border border-brand-blue/10 bg-brand-blue/5 hover:bg-brand-blue/10 transition-colors">
