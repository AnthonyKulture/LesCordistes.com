        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    ...
                    <Button variant="primary" onClick={() => navigate('/jobs')}>Voir toutes les missions</Button>
                </div>
            </div>
        );
    }
            ...
            <div className="min-h-screen bg-slate-50">
                <div className="container max-w-5xl py-6">
                    ...
                    <nav className="flex items-center gap-1.5 text-xs sm:text-sm text-slate-400 mb-5">
                        ...
                        <Link 
                            to={isOwner || profile?.role === 'client' ? "/dashboard" : "/jobs"} 
                    ...
                    <button
                        onClick={() => navigate(isOwner || profile?.role === 'client' ? '/dashboard' : '/jobs')}
