                        ...
                        return (
                            <div key={key} className="mb-14 last:mb-0">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {terms.map(term => (
                                        <Link key={term.slug} href={`/lexique/${term.slug}`} className="bg-slate-50 border border-slate-100 p-6 rounded-xl hover:shadow-md hover:bg-white hover:border-brand-blue/30 transition-all group block">
