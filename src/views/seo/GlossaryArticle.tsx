        ...
        <div className="min-h-screen bg-slate-50 pt-24 pb-16">
            ...
            <div className="container max-w-3xl">
                ...
                <div className="mt-12 bg-white rounded-2xl border border-slate-200 p-8 text-center flex flex-col items-center justify-center">
                    ...
                    <Link href="/post-job" className="bg-brand-blue hover:bg-brand-blue-light text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-brand-blue/40 hover:-translate-y-1">
