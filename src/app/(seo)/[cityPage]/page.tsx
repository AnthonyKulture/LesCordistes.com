...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        ...
        description: `Trouvez un cordiste qualifié à ${city.name} pour vos travaux en accès difficile. Devis gratuit sous 48h. Experts certifiés CQP/IRATA.`,
        alternates: { canonical: `https://lescordistes.com/cordiste-${citySlug}` },
        openGraph: {
            title: `Cordiste ${city.name} : Experts Travaux en Hauteur`,
            description: `Trouvez un cordiste qualifié à ${city.name}. Devis gratuit sous 48h.`,
